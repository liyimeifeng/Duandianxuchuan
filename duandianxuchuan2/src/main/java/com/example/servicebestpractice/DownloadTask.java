...
public class DownloadTask extends AsyncTask<String,Integer,Integer> {
    ...
    protected Integer doInBackground(String... params) {
        ...
        if(file.exists()){
            //如果文件存在的话，得到文件的大小
            Log.e("=============", "现在的文件长度============>"+ file.length() );

            downloadLength=file.length();
        }
        Log.e("=============", "没有目标文件============>"+ file.length() );
...
//                        Log.e("=============", "len=============>"+ len );
                        ...
                        //计算已经下载的百分比
//                        Log.e("=============", "total=============>"+ total  + "====downloadLength==="  + downloadLength);
//                        Log.e("=============", "total+downloadLength=============>"+ total+downloadLength );
